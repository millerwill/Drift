Shader "Spline Architect/GPU Instanced Lit (Example)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                half lightAmount = saturate(dot(normalize(input.normalWS), mainLight.direction));
                lightAmount *= mainLight.shadowAttenuation;

                half3 lighting = mainLight.color * lightAmount + _Ambient;
